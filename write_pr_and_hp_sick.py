...
def process_sick_data(infile):
    prefix = infile.split('.txt')[0]
    outfile_pr = prefix + '.premise'
    outfile_hp = prefix + '.hypothesis'
...
if __name__ == '__main__':
    print "Processing SICK data..."
    process_sick_data(SICK_DATA_FILE)